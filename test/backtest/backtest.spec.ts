...
// import { WalletInterface } from '../../src/modules/wallet/wallet.interface';
// import { BinanceMarketService } from '../../src/modules/binance/binance-market.service';
// import { SignalType, StrategyContext } from '../../src/modules/strategy/core/trade.types';
// import { IStrategy } from '../../src/modules/strategy/core/strategy.interface';
//
...
//       providers: [
//         BacktestService,
//         { provide: BinanceMarketService, useValue: mockBinanceService },
...
//
//     await expect(service.runBacktest('BNB/USDT', '15m', 50, 'mock', 1000)).rejects.toThrow('No candles data received');
//   });
//
//   it('should throw if strategy not found', async () => {
//     await expect(service.runBacktest('BNB/USDT', '15m', 50, 'notExist', 1000)).rejects.toThrow('Strategy notExist not found');
//   });
//
